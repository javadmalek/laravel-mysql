...
class CircleController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($userType == 'PURCHASER') {
            ...
            return View::make('circles.purchaser.index', ['circles' => $myCircle, 'companies' => $companies]);
    ...
    public function filter(Request $request)
    {
        ...
        return View::make('circles.purchaser.filter', ['_src_company' => $company, 'companies' => $companies, 'filteredCompanies' => $filteredCompanies]);
    }
    ...
    public function status($_circle_id, $_status)
    {
        ...
        return Redirect::to('purchaser/companies/circles');
    }
    ...
    public function receivedRequets()
    {
        ...
        return View::make('circles.purchaser.requests')
