        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="m-portlet">
                    ...
                    {{ Form::open(array('url' => 'purchaser/companies/catalogs/',
                                        'files'=>true,
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3">
                                <div class="m-radio-inline">
                                    {{ Form::select('type', array('PRO' => 'PRODUCT', 'SER' => 'SERVICE', 'MAC' => 'MACHINE'), Input::old('type'), array('class' => 'form-control m-input')) }}
                                </div>
