        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="m-portlet">
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                ...
                                <h3 class="m-portlet__head-text">Edit catalog {{ $catalog->title  }}</h3>
                            </div>
                        </div>
                    </div>
                    <!--begin::Form-->
                    ...
                    {{ Html::ul($errors->all()) }}
                    {{ Form::model($catalog, array('route' => array('purchaser.companies.catalogs.update',$catalog->id),
                                        'files'=>true,
                    ...
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3">
                                {{ Form::text('title', $catalog->title, array('class' => 'form-control m-input', 'placeholder' => 'Enter your Catalog Title', 'required' => 'required')) }}
                            ...
                            <div class="col-lg-3">
                                <div class="m-radio-inline">
                                    {{ Form::select('type', array('PRO' => 'PRODUCT', 'SER' => 'SERVICE', 'MAC' => 'MACHINE'), $catalog->type, array('class' => 'form-control m-input')) }}
                                </div>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3">
                                {{ Form::text('application', $catalog->application, array('class' => 'form-control m-input', 'placeholder' => 'Enter your Catalog Application', 'required' => 'required')) }}
                            ...
                            <div class="col-lg-3">
                                {{ Form::text('keywords', $catalog->keywords, array('class' => 'form-control m-input', 'placeholder' => 'Enter your catalog Keywords')) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3">
                                {{ Form::text('standards', $catalog->standards, array('class' => 'form-control m-input', 'placeholder' => 'Enter your Catalog Standards', 'required' => 'required')) }}
                                <span class="m-form__help">Please enter your Catalog Standards</span>
                            </div>

                            {{ Form::label('crc', 'CRC', array( 'class' => 'col-lg-2 col-form-label')) }}
                            <div class="col-lg-3">
                                {{ Form::text('crc', $catalog->crc, array('class' => 'form-control m-input', 'placeholder' => 'Enter your catalog CRC')) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3">
                                {{ Form::text('price', $catalog->price, array('class' => 'form-control m-input', 'placeholder' => 'Enter your Catalog Price', 'required' => 'required')) }}
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-6">
                                {{ Form::textarea('description', $catalog->description, array('class' => 'form-control m-input m-input--air', 'placeholder' => 'Enter your catalog description')) }}
                            </div>
                        </div>
