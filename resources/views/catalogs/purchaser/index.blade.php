            ...
            <div class="col-xl-12">
                <div class="m-portlet m-portlet--mobile ">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <!-- Start Search -->
                        {{ Form::open(array('url' => 'purchaser/companies/catalogs/filter', 'method' => 'POST', 'class' => 'm-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed', 'id' => '"maskForm"')) }}
                        <div class="m-portlet__body">
                                ...
                                <table class="table m-table m-table--head-no-border">
                                    ...
                                    <tr>
                                        ...
                                        <th><a class="btn m-btn--square  btn-outline-info pull-right"
                                               href="{{ URL::to('purchaser/companies/catalogs/create') }}">Create a Catalog</a></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn m-btn--square  btn-outline-info"
                                                       href="{{ URL::to('purchaser/companies/catalogs/' . $value->id . '/edit') }}">Edit</a>
                                                    <a class="btn m-btn--square  btn-outline-info"
                                                       href="{{ URL::to('purchaser/companies/catalogs/' . $value->id) }}">View</a>

                                                    {{ Form::open(array('url' => 'purchaser/companies/catalogs/' . $value->id, 'class' => 'pull-right')) }}
                                        ...
                                        @elseif( $filter_key == '')
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @include('catalogs.purchaser.show')
