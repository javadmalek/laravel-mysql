        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="m-portlet">
                    ...
                    {{ Html::ul($errors->all()) }}
                    {{ Form::model($catalog, array('route' => array('supplier.companies.catalogs.update',$catalog->id),
                                        'files'=>true,
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3">
                                <div class="m-radio-inline">
                                    {{ Form::select('type', array('PRO' => 'PRODUCT', 'SERVICE' => 'SER', 'MAC' => 'MACHINE'), $catalog->type, array('class' => 'form-control m-input')) }}
                                </div>
