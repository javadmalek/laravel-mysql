            ...
            <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                    <a href=""
                       ...
                       data-toggle="modal" data-target="#type_model">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href=""
                                   ...
                                   data-toggle="modal" data-target="#type_model_edit_{{ $value->id }}">
                                    Edit
                                </a>
                                <div class="modal fade" id="type_model_edit_{{ $value->id }}" tabindex="-1"
                                            ...
                                            <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                                                <div class="m-form__actions m-form__actions--solid m-form__actions--right">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-10">
                                                            {{ Form::submit('Update the Type!', array('class' => 'btn btn-success')) }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<div class="modal fade" id="type_model" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <input id="variable" type="hidden" name="variable" value="T">
                </div>
            </div>
            <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                <div class="m-form__actions m-form__actions--solid m-form__actions--right">
