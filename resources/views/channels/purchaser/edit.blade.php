...
@section('content')
    ...
    <div class="m-content">
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="m-portlet">
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                ...
                                <h3 class="m-portlet__head-text">Edit the <b>{{ $channel->title }}</b> Profile</h3>
                            </div>
                        </div>
                    </div>
                    <!--begin::Form-->
                    ...
                    {{ Form::model($channel, array('route' => array('purchaser.channels.update', $channel->id), 'method' => 'PUT', 'class' => 'm-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed', 'id' => '"maskForm"')) }}
        ...
        <div class="row">
            <div class="col-xl-4">
                @include('channels.purchaser.add-variable-type')
            </div>
            <div class="col-xl-4">
                @include('channels.purchaser.add-variable-dimension')
            </div>
        </div>
