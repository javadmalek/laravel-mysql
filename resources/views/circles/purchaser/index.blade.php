            ...
            <div class="col-xl-12">
                <div class="m-portlet m-portlet--mobile ">
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                <h3 class="m-portlet__head-text">Companies in your circle</h3>
                            </div>
                        </div>
                    </div>
                    <div class="m-portlet__body">
                        ...
                        <div class="m-section">
                            <!-- Start Search -->
                            {{ Form::open(array('url' => 'purchaser/companies/circles/filter', 'method' => 'POST',
                            ...
                            <div class="m-section__content">
                                <div class="row">
                                    @foreach($circles as $key => $circle)
                                        @include('circles.purchaser.contact-circle')
                                    @endforeach
                                </div>
                            </div>
