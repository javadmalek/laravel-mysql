                ...
                <div class="m-portlet__head-title">
                    ...
                    <div class="m-portlet__body" style="text-align: justify">
                        ...
                        @if($circle->status == 'ACCEPTED')
                            <a class="btn m-btn--square  btn-outline-info"
                               href="{{ URL::to('supplier/companies/circles/'. $circle->id.'/status/unfollow') }}">Unfollow</a>
                        @elseif($circle->status == 'REQUESTED')
                            <a class="btn m-btn--square  btn-outline-info"
                               href="{{ URL::to('supplier/companies/circles/'. $circle->id.'/status/cancelrequest') }}">Cancel Request</a>
                        @endif
                    </div>
