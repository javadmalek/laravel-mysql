        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="m-portlet">
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                ...
                                <h3 class="m-portlet__head-text">Edit the {{ $company->title }} Profile</h3>
                            </div>
                        </div>
                    </div>
                    <!--begin::Form-->
                    ...
                    {{ Form::model($company, array('route' => array('purchaser.companies.update', $company->id), 'method' => 'PUT', 'class' => 'm-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed', 'id' => '"maskForm"')) }}
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            {{ Form::label('country_id', 'Country', array( 'class' => 'col-lg-2 col-form-label')) }}
                            <div class="col-lg-3">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3">
                                <div class="m-radio-inline">
                                    {{ Form::select('operation_type', array('NaN' => 'Select a Type', 'PURCHASER' => 'Purchaser Company', 'SUPPLIER' => 'Supplier'), Input::old('operation_type'), array('class' => 'form-control m-input')) }}
                                </div>
