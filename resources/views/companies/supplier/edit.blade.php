        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="m-portlet">
                    ...
                    {{ Form::model($company, array('route' => array('supplier.companies.update', $company->id), 'method' => 'PUT', 'class' => 'm-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed', 'id' => '"maskForm"')) }}
