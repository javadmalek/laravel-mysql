                    ...
                    <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"
                        ...
                        <div class="m-menu__submenu">
                            ...
                            <ul class="m-menu__subnav">
                                ...
                                <li class="m-menu__item " aria-haspopup="true">
                                    <a href="{{ url('/purchaser/profile-view') }}" class="m-menu__link ">
                                        <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                            <span></span>
                                        </i>
                                        <span class="m-menu__link-text">
                    ...
                    <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"
                        ...
                        <div class="m-menu__submenu">
                            ...
                            <ul class="m-menu__subnav">
                                ...
                                <li class="m-menu__item " aria-haspopup="true">
                                    <a href="{{ url('/purchaser/profile-edit') }}" class="m-menu__link ">
                                        <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                            <span></span>
                                        </i>
                                        <span class="m-menu__link-text">
...
<!--end::Page Resources -->
<!--begin::Page Resources -->
<script src="{{asset('assets/demo/default/custom/components/forms/widgets/bootstrap-datepicker.js')}}" type="text/javascript"></script><!--end::Page Resources -->
</body>
<!-- end::Body -->
</html>
