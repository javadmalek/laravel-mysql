<div class="modal fade" id="message_model{{$offer->id}}" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        ...
        <!--begin::Form-->
            {{ Html::ul($errors->all()) }}
            {{ Form::open(array('url' => 'purchaser/messages/' . $offer->rfq->channel->id.'/' . $offer->rfq->id.'/' . $offer->id .'/'.  $offer->supplier->id . '/send',
                                'method' => 'POST',
                    ...
                    <div class="m-section__content">
                        <table class="table m-table m-table--head-no-border">
                            ...
                            @foreach($offer->messages as $key => $msg)
                                <tr>
                                    @if($offer->purchaser->id == $msg->sender->id)
