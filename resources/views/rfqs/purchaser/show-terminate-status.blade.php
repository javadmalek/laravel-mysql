        ...
        <div class="modal-content">
            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        <strong> {{ $value->deal->purchaser_terminate_status }}</strong>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-6">
                        <strong> {{ $value->deal->purchaser_terminate_descr }}</strong>
                    </div>
                </div>
            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        <strong> {{ $value->deal->supplier_terminate_status }}</strong>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-6">
                       <strong> {{ $value->deal->supplier_terminate_descr }}</strong>
                    </div>
                </div>
